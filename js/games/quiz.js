...
export function startQuizGame() {
    ...
    const motivationalPhrases = [
        ...
        'Продолжай пробовать! Знания приходят с практикой! 🌟',
        'Ничего страшного! Главное - не останавливаться! 🚀',
        ...
        'Каждый новый вопрос - это новая возможность! 🎲',
        'Ты становишься лучше с каждым ответом! ⭐',
